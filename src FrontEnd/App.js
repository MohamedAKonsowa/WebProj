    ...
    import downloadImage from 'C:\\Users\\alieh\\WebstormProjects\\untitled10\\src\\hoddie.jpg';
    import downloadImage2 from 'C:\\Users\\alieh\\WebstormProjects\\untitled10\\src\\OIP.jpg';
    ...
    function App() {
        const productsData = [
            ...
            { id: 2, imageSrc: downloadImage2, productName: 'Product 3' , description: 'description', quantity: 0},
            { id: 3, imageSrc: downloadImage2, productName: 'Product 4' , description: 'description', quantity: 0},
            ...
            { id: 6, imageSrc: downloadImage2, productName: 'Product 7' , description: 'description', quantity: 0},
                ...
                <div className={"test1"}>
                    ...
                    <div>
                        <SearchPage showSearchSection={showSearchSection} showProductSection={showProductSection}
                                    ...
                                    toggle  ProductDescriptionSection={toggleProductDescriptionSection}
